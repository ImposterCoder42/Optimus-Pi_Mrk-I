...
def setup():
    ...
    GPIO.setup(right_motor_pin2, GPIO.OUT, initial=GPIO.LOW)
    GPIO.setup(left_motor_pin1, GPIO.OUT, initial=GPIO.LOW)
    GPIO.setup(left_motor_pin2, GPIO.OUT, initial=GPIO.LOW)
...
class MotorDriverNode(Node):
    ...
    def motor_input_cb(self, msg):
        ...
        self.get_logger().info(f'left motor: {lt_motor_1}/{lt_motor_2}')
        self.get_logger().info(f'right motor: {rt_motor_1}/{rt_motor_2}')
