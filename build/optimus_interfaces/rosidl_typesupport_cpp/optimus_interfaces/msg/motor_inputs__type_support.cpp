...
static const _MotorInputs_type_support_symbol_names_t _MotorInputs_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, optimus_interfaces, msg, MotorInputs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, optimus_interfaces, msg, MotorInputs)),
  }
};
...
{
  return &::optimus_interfaces::msg::rosidl_typesupport_cpp::MotorInputs_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, optimus_interfaces, msg, MotorInputs)() {
  return get_message_type_support_handle<optimus_interfaces::msg::MotorInputs>();
}
