...
#include "optimus_interfaces/msg/detail/motor_inputs__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const optimus_interfaces::msg::MotorInputs & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  optimus_interfaces::msg::MotorInputs & ros_message)
{
  // Member: left_motor
  cdr >> ros_message.left_motor;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_optimus_interfaces
max_serialized_size_MotorInputs(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = optimus_interfaces::msg::MotorInputs;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_optimus_interfaces
max_serialized_size_key_MotorInputs(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const optimus_interfaces::msg::MotorInputs *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<optimus_interfaces::msg::MotorInputs *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorInputs__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const optimus_interfaces::msg::MotorInputs *>(
...
static size_t _MotorInputs__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorInputs(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorInputs__callbacks = {
...
static rosidl_message_type_support_t _MotorInputs__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorInputs__callbacks,
...
{
  return &optimus_interfaces::msg::typesupport_fastrtps_cpp::_MotorInputs__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, optimus_interfaces, msg, MotorInputs)() {
  return &optimus_interfaces::msg::typesupport_fastrtps_cpp::_MotorInputs__handle;
}
