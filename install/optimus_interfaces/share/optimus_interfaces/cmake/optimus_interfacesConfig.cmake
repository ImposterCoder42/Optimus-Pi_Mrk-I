...
if(_optimus_interfaces_CONFIG_INCLUDED)
  # ensure to keep the found flag the same
  if(NOT DEFINED optimus_interfaces_FOUND)
    # explicitly set it to FALSE, otherwise CMake will set it to TRUE
    set(optimus_interfaces_FOUND FALSE)
  elseif(NOT optimus_interfaces_FOUND)
    # use separate condition to avoid uninitialized variable warning
    set(optimus_interfaces_FOUND FALSE)
  endif()
  return()
endif()
set(_optimus_interfaces_CONFIG_INCLUDED TRUE)
...
if(NOT "" STREQUAL "")
  set(_msg "Package 'optimus_interfaces' is deprecated")
  # append custom deprecation text if available
  if(NOT "" STREQUAL "TRUE")
    set(_msg "${_msg} ()")
  endif()
  # optionally quiet the deprecation message
  if(NOT optimus_interfaces_DEPRECATED_QUIET)
    message(DEPRECATION "${_msg}")
  endif()
endif()

# flag package as ament-based to distinguish it after being find_package()-ed
set(optimus_interfaces_FOUND_AMENT_PACKAGE TRUE)
...
foreach(_extra ${_extras})
  include("${optimus_interfaces_DIR}/${_extra}")
endforeach()
